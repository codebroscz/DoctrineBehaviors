...
return static function (): \Psr\Container\ContainerInterface {
    ...
    $container->set(
        ...
        static function (Psr\Container\ContainerInterface $c): \Doctrine\ORM\Configuration {
            $config = new \Doctrine\ORM\Configuration();
            $config->setMetadataDriverImpl(
                new \Doctrine\ORM\Mapping\Driver\AttributeDriver([__DIR__ . '/../../tests/Fixtures/Entity'])
            );
    ...
    $container->set(
        ...
        static function (Psr\Container\ContainerInterface $c): \Doctrine\DBAL\Connection {
    ...
    $container->set(
        ...
        static function (Psr\Container\ContainerInterface $c): \Doctrine\ORM\EntityManagerInterface {
            ...
            $evm->addEventSubscriber(new LoggableEventSubscriber($c->get(TestLogger::class),));
    ...
    $container->set(DatabaseLoader::class, static function (Psr\Container\ContainerInterface $c): DatabaseLoader {
        return new DatabaseLoader($c->get(\Doctrine\ORM\EntityManagerInterface::class), $c->get(
            \Doctrine\DBAL\Connection::class
        ));
    });

    $container->set(
        LoggableEventSubscriber::class,
        static function (Psr\Container\ContainerInterface $c): LoggableEventSubscriber {
